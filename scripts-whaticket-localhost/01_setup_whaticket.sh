...
echo "Configurando Docker para o usuário 'pedro' e criando container Redis..."
usermod -aG docker pedro
...
git clone https://github.com/SEUGITHUB/novo_whaticket.git /home/pedro/whaticket
chown pedro:pedro -R /home/pedro/whaticket
sleep 2
echo "[OK] Repositório clonado."

echo " "
echo "Faça login com a conta do usuário pedro para finalizar a instalação e configuração"